...
def create_root_graph():
    """ Use Matplotlib to create cubic graph with marked root point """
    ...
    # Graph points, and mark root point
    graph.plot(xs, ys)
    graph.plot([0.5653], [0], marker='o', markersize=10, mfc='none', color='red')
    graph.grid()
